...
const mockupViewer = document.querySelector('.mockups-container');
...
function gridlyRules(): HTMLDivElement {
  ...
  mockupViewer.appendChild(rulesElement);
...
mockupViewer.appendChild(columnsBox);
mockupViewer.appendChild(rowsBox);
